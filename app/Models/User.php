...
class User extends Authenticatable
{
    ...
    {
        return User::where('id', $id)->pluck('apellido')->first();
    }
    ...
    {
        $user = (object)array('rut' => User::where('id', $id)->pluck('rut')->first(), 'name' => User::where('id', $id)->pluck('name')->first(), 'apellido' => User::where('id', $id)->pluck('apellido')->first(), 'telefono' => User::where('id', $id)->pluck('telefono')->first(), 'email' => User::where('id', $id)->pluck('email')->first(), 'direccion' => User::where('id', $id)->pluck('direccion')->first());
        return $user;
    }
}
